...
const Board = () => ***REMOVED***
  ...
  const handleTabChange = (value: string) => ***REMOVED***
    setSearchParams(***REMOVED*** category: value ***REMOVED***);
  ***REMOVED***
  ...
  useEffect(() => ***REMOVED***
    if (productList) ***REMOVED***
        ...
        ***REMOVED***);
        ...
        setFilteredProductList((prev) => ***REMOVED***
            if (JSON.stringify(prev) !== JSON.stringify(filtered)) ***REMOVED***
                return filtered;
            ***REMOVED***
            return prev;
        ***REMOVED***);
