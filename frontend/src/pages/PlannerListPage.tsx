...
const PlannerList = () => ***REMOVED***
  ...
  ***REMOVED***[category];
  ...
  const handleValueChange = (value: string) => ***REMOVED***
  ...
  ***REMOVED***
  ...
  return (
    <RadioGroup onValueChange=***REMOVED***handleValueChange***REMOVED***>
      ...
      <div className="flex flex-wrap justify-center gap-8 mt-5 mb-5">
        ***REMOVED***dummyList.map((dummy, index) => (
          <div key=***REMOVED***index***REMOVED***>
            <RecommendBox src=***REMOVED***dummy.src***REMOVED*** name=***REMOVED***dummy.name***REMOVED*** price=***REMOVED***dummy.price***REMOVED*** />
          </div>
        ))***REMOVED***
      </div>
