...
const Planner = () => ***REMOVED***
  ...
  //     const ***REMOVED*** studios, dresses, makeups ***REMOVED*** = recommendList.reduce(
  //       (acc, product) => ***REMOVED***
  ...
  //         return acc;
  //       ***REMOVED***,
  //       ***REMOVED*** studios: [], dresses: [], makeups: [] ***REMOVED***
  //     );
    ...
    <div className="flex flex-col relative">
      <div className="m-5 flex flex-col items-center">
        ...
        ***REMOVED***dummyList.map((dummy, index) => (
          <PlannerBox
            ...
            title=***REMOVED***dummy.category***REMOVED***
            company=***REMOVED***dummy.company***REMOVED***
            price=***REMOVED***dummy.price***REMOVED***
            content=***REMOVED***dummy.content***REMOVED***
          />
        ))***REMOVED***
      ...
      <div className="flex justify-end mr-10 mt-14">
        ...
        <div className="flex flex-col text-end">
          ***REMOVED***dummyList.map((dummy, index) => (
            <span key=***REMOVED***index***REMOVED*** className="my-1">
              ***REMOVED***dummy.price.toLocaleString()***REMOVED***원
            </span>
          ))***REMOVED***
