...
public class Sketch ***REMOVED***
    ...
    @Builder
    public Sketch(SketchRequestDto requestDto, String image, UserEntity user) ***REMOVED***
        this.image = image;
    ...
    ***REMOVED***
    ...
    public SketchResponseDto getUserSketch(Sketch sketch) ***REMOVED***
